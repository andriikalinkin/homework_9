...
urlpatterns = [
    ...
    path("select_car_type/<int:dealership_id>/", views.select_car_type, name="select_car_type"),
    path("select_car_and_license/<int:car_type_id>/", views.select_car_and_license, name="select_car_and_license"),
