...
urlpatterns = [
    ...
    path("select_dealership/", views.select_dealership, name="select_dealership"),  # Create order
    path("select_car_type/", views.select_car_type, name="select_car_type"),
    path("select_car_and_license/", views.select_car_and_license, name="select_car_and_license"),
